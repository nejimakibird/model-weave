...
| search_button    | Search           | button | actions |           |          |                                              | [[../codeset/CODE-INVENTORY-STATUS]].available |                                             | Execute search      |
...
| ACT-SEARCH | Search       | ui_action    | search_button | click | [[../codeset/CODE-INVENTORY-STATUS]].available | [[../app_process/PROC-INVENTORY-SEARCH]] |                  | [[../rule/RULE-INVENTORY-SEARCH-CONDITION]] | Show results in inventory_table |
...
|---|---|---|---|---|---|
| MSG-NO-RESULT | [[../message/MSGSET-INVENTORY]].INV-INFO-001 | info | search_result | [[../codeset/CODE-INVENTORY-STATUS]].shortage | No rows found |
...
|---|---|---|---|---|---|---|---|---|---|
| STEP-DEFAULT-STATUS | Set default status | process | [[../codeset/CODE-INVENTORY-STATUS]].available |  |  |  |  |  | Default status filter |
| STEP-CLEAR-RESULTS | Clear previous results | process |  |  |  |  |  |  | Clear previous search results |

#### Errors

| id | condition | message | notes |
|---|---|---|---|
| ERR-STOCK-SHORTAGE | [[../codeset/CODE-INVENTORY-STATUS]].shortage | [[../message/MSGSET-INVENTORY]].INV-INFO-001 | Example structured error condition |
