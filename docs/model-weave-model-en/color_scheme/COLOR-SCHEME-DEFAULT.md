...
Default Color Scheme for Model Weave sample diagrams.

Set `defaultColorSchemeRef` to `[[COLOR-SCHEME-DEFAULT]]` in Model Weave settings to preview colors in Domains, Domain Diagram, DFD, and app_process Business Flow views.
...
| domain | business | #4f81bd | #2f5597 | #ffffff | Business / organization domain |
| domain | application | #9bbb59 | #6f8a3f | #000000 | Application domain |
| domain | model | #8faadc | #5b7dbb | #000000 | Model / design definition domain |
| domain | renderer | #70ad47 | #507e32 | #000000 | Renderer / preview domain |
