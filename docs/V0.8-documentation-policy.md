...
V0.7 defined the rendering policy for Custom / Mermaid rendering and `render_mode`.
...
## Relationship to V0.7 rendering policy

V0.7 rendering policy remains the rendering policy.

This V0.8 documentation policy does not replace it.

Use:

* [V0.7 rendering policy](V0.7-rendering-policy.md) for renderer behavior, `render_mode`, Custom / Mermaid policy, and DFD Mermaid-first guidance.
